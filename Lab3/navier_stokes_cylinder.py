...
cylinder2 = Circle(Point(0.6, 0.15), 0.1)
...
cylinder2 = 'on_boundary && x[0]>0.4 && x[0]<0.8 && x[1]>0.05 && x[1]<0.35'


# Define inflow profile
inflow_profile = ('exp(-x[1])*sin(0.41 - x[1])', '0')
...
bcu = [bcu_inflow, bcu_walls, bcu_cylinder, bcu_cylinder2]
bcp = [bcp_outflow]
